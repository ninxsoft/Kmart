...
enum ReportType: String, CaseIterable {
    ...
    var endpoints: [Endpoint] {
        switch self {
        case .buildingsNotLinked:                    return [
            .buildings, .networkSegments, .macApplications, .macConfigurationProfiles, .macDevices, .macPolicies, .macRestrictedSoftware,
            .mobileApplications, .mobileConfigurationProfiles, .mobileDevices
        ]
        case .categoriesNotLinked:                   return [
            .categories, .macApplications, .macConfigurationProfiles, .macPackages, .macPolicies, .macPrinters, .macScripts, .mobileApplications, .mobileConfigurationProfiles]
        case .departmentsNotLinked:                  return [
            .departments, .networkSegments, .macApplications, .macConfigurationProfiles, .macDevices, .macPolicies, .macRestrictedSoftware,
            .mobileApplications, .mobileConfigurationProfiles, .mobileDevices
        ]
        case .eBooksNoScope:                         return [.eBooks]
        case .iBeaconsNotLinked:                     return [.iBeacons, .macConfigurationProfiles, .macPolicies, .mobileConfigurationProfiles]
        case .macAdvancedSearchesNoCriteria:         return [.macAdvancedSearches]
        case .macAdvancedSearchesInvalidCriteria:    return [.macAdvancedSearches, .macGroups]
        case .macApplicationsNoScope:                return [.macApplications]
        case .macConfigurationProfilesNoScope:       return [.macConfigurationProfiles]
        case .macDevicesDuplicateNames:              return [.macDevices]
        ...
        case .macExtensionAttributesNotLinked:       return [.macAdvancedSearches, .macExtensionAttributes, .macGroups]
        case .macExtensionAttributesDisabled:        return [.macExtensionAttributes]
        case .macExtensionAttributesLinterErrors:    return [.macExtensionAttributes]
        case .macExtensionAttributesLinterWarnings:  return [.macExtensionAttributes]
        ...
        case .macPrintersNotLinked:                  return [.macPolicies, .macPrinters]
        case .macRestrictedSoftwareNoScope:          return [.macRestrictedSoftware]
        case .macScriptsNotLinked:                   return [.macScripts, .macPolicies]
        case .macScriptsLinterErrors:                return [.macScripts]
        case .macScriptsLinterWarnings:              return [.macScripts]
        case .macSmartGroupsNotLinked:               return [.macAdvancedSearches, .macApplications, .macConfigurationProfiles, .macPolicies, .macRestrictedSoftware, .macGroups]
        case .macSmartGroupsNoCriteria:              return [.macGroups]
        case .macStaticGroupsNotLinked:              return [.macAdvancedSearches, .macApplications, .macConfigurationProfiles, .macPolicies, .macRestrictedSoftware, .macGroups]
        case .macStaticGroupsEmpty:                  return [.macGroups]
        case .mobileAdvancedSearchesNoCriteria:      return [.mobileAdvancedSearches]
        case .mobileAdvancedSearchesInvalidCriteria: return [.mobileAdvancedSearches, .mobileGroups]
        ...
        case .mobileStaticGroupsNotLinked:           return [.mobileAdvancedSearches, .mobileApplications, .mobileConfigurationProfiles, .mobileGroups]
        case .mobileStaticGroupsEmpty:               return [.mobileGroups]
        case .networkSegmentsNotLinked:              return
            [.buildings, .departments, .eBooks, .networkSegments, .macApplications, .macConfigurationProfiles, .macPolicies, .mobileApplications, .mobileConfigurationProfiles]
        }
    }
    ...
    var markdownDescription: String {
        switch self {
        case .buildingsNotLinked:                    return "The following Buildings are not linked to anything"
        case .categoriesNotLinked:                   return "The following Categories are not linked to anything"
        case .departmentsNotLinked:                  return "The following Departments are not linked to anything"
        case .eBooksNoScope:                         return "The following eBooks have no scope"
        case .iBeaconsNotLinked:                     return "The following iBeacons are not linked to anything"
        case .macAdvancedSearchesNoCriteria:         return "The following Mac Advanced Searches have no criteria"
        case .macAdvancedSearchesInvalidCriteria:    return "The following Mac Advanced Searches have invalid criteria"
        case .macApplicationsNoScope:                return "The following Mac Applications have no scope"
        case .macConfigurationProfilesNoScope:       return "The following Mac Configuration Profiles have no scope"
        case .macDevicesDuplicateNames:              return "The following Mac Devices have duplicated names"
        ...
        case .macDirectoryBindingsNotLinked:         return "The following Mac Directory Bindings are not linked to anything"
        case .macDiskEncryptionsNotLinked:           return "The following Mac Disk Encryptions are not linked to anything"
        case .macDockItemsNotLinked:                 return "The following Mac Dock Items are not linked to anything"
        case .macExtensionAttributesNotLinked:       return "The following Mac Extension Attributes are not linked to anything"
        case .macExtensionAttributesDisabled:        return "The following Mac Extension Attributes are disabled"
        case .macExtensionAttributesLinterErrors:    return "The following Mac Extension Attributes have linter errors"
        case .macExtensionAttributesLinterWarnings:  return "The following Mac Extension Attributes have linter warnings"
        case .macPackagesNotLinked:                  return "The following Mac Packages are not linked to anything"
        ...
        case .macPrintersNotLinked:                  return "The following Mac Printers are not linked to anything"
        case .macRestrictedSoftwareNoScope:          return "The following Mac Restricted Software have no scope"
        case .macScriptsNotLinked:                   return "The following Mac Scripts are not linked to anything"
        case .macScriptsLinterErrors:                return "The following Mac Scripts have linter errors"
        case .macScriptsLinterWarnings:              return "The following Mac Scripts have linter warnings"
        case .macSmartGroupsNotLinked:               return "The following Mac Smart Groups are not linked to anything"
        case .macSmartGroupsNoCriteria:              return "The following Mac Smart Groups have no criteria"
        case .macStaticGroupsNotLinked:              return "The following Mac Static Groups are not linked to anything"
        case .macStaticGroupsEmpty:                  return "The following Mac Static Groups are empty"
        case .mobileAdvancedSearchesNoCriteria:      return "The following Mobile Advanced Searches have no criteria"
        case .mobileAdvancedSearchesInvalidCriteria: return "The following Mobile Advanced Searches have invalid criteria"
        ...
        case .mobileStaticGroupsNotLinked:           return "The following Mobile Static Groups are not linked to anything"
        case .mobileStaticGroupsEmpty:               return "The following Mobile Static Groups are empty"
        case .networkSegmentsNotLinked:              return "The following Network Segments are not linked to anything"
        }
    }

    var jamfProSlug: String {
        switch self {
        case .buildingsNotLinked:                                                                                                     return "/view/settings/network/buildings/"
        case .categoriesNotLinked:                                                                                                    return "categories.html?id="
        case .departmentsNotLinked:                                                                                                   return "/view/settings/network/departments/"
        case .eBooksNoScope:                                                                                                          return "eBooks.html?id="
        case .iBeaconsNotLinked:                                                                                                      return "ibeacons.html?id="
        ...
        case .macSmartGroupsNotLinked, .macSmartGroupsNoCriteria:                                                                     return "smartComputerGroups.html?id="
        case .macStaticGroupsNotLinked, .macStaticGroupsEmpty:                                                                        return "staticComputerGroups.html?id="
        ...
        case .networkSegmentsNotLinked:                                                                                               return "/networkSegments.html?id="
        }
    }
}
